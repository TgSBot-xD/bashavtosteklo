  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          'bg-accent data-[state=open]:animate-in data-[state=closed]:animate-out dark:bg-sidebar-border fixed z-50 flex flex-col gap-4 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 dark:backdrop-blur-sm',
          side === 'right' &&
      ...
      >
        ...
        <SheetPrimitive.Close
          className={cn(
            `ring-offset-background focus:ring-ring data-[state=open]:bg-secondary absolute top-4 right-4 rounded-xs opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none ${showCloseButton ? '' : 'hidden'}`,
          )}
        >
