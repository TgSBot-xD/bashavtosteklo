...
function HeroSection() {
  return (
    <article data-testid="hero-section" className="flex w-full flex-col gap-4 lg:gap-8">
      <div className="flex w-full flex-col items-center gap-2 md:gap-8 md:px-5 lg:m-auto lg:max-w-7xl lg:justify-between lg:gap-10 lg:px-0 xl:flex-row xl:gap-8">
        <HeroContent />
